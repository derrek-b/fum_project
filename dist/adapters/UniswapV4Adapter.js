...
export default class UniswapV4Adapter extends PlatformAdapter {
  ...
  async generateCreatePositionData(params) {
    ...
    try {
      ...
      // Create SDK Token instances for the sorted tokens
      const sdkToken0 = new Token(this.chainId, sortedToken0.address, sortedToken0.decimals);
      const sdkToken1 = new Token(this.chainId, sortedToken1.address, sortedToken1.decimals);
